...
<head>
    ...
    <?php wp_head(); ?>
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Robot<?php bloginfo('template_directory'); ?>/o:300,300i,400,400i,500,500i">
                    ...
                    <div class="row">
                        <div class="col-6 col-xs-6 col-sm-6 col-md-3 col-lg-3 order-md-0 order-0">
                            <div class="logo">
                                <a href="<?php bloginfo('url'); ?>"><img
                                        src="<?php bloginfo('template_directory'); ?>/images/logo.png"
                        ...
                        <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 order-md-1 order-2">
                            <div class="form-seach-product">
                                <form action="<?php echo bloginfo('url'); ?>" method="GET" role="form">
                                    ...
                                    <div class="input-seach">
                                        <input type="search" name="s" id="<?php esc_attr(uniqid('search-form-')); ?>"
                                            class="form-control" value="<?php the_search_query(); ?>">
